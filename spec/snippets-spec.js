...
`
    ...
    describe("when a previous snippet expansion has just been undone", () => it("expands the snippet based on the current prefix rather than jumping to the old snippet's tab stop", function() {
