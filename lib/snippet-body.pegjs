...
format = formatWithIfAlt / formatWithIfElseAlt / simpleFormat / formatWithoutPlaceholder / formatWithCaseTransform / formatWithIf / formatWithIfElse / formatWithElse / formatEscape
...
ifElseTextAlt = text:(escaped / char:[^)] { return char })+ {
  return text.join('')
}
